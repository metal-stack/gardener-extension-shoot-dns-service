...
var _ = Describe("Validation", func() {
	...
	DescribeTable("#ValidateDNSConfig",
		...
		Entry("invalid provider type", service.DNSConfig{
			...
			"Detail":   Equal("unsupported provider type. Valid types are: alicloud-dns, aws-route53, azure-dns, azure-private-dns, cloudflare-dns, google-clouddns, infoblox-dns, netlify-dns, openstack-designate, remote, powerdns"),
		})),
